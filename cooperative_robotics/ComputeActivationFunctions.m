...
uvms.A.distGoal = diag([IncreasingBellShapedFunction(uvms.ensured_distance_x, uvms.ensured_distance_x + 0.5, 0, 1, abs(uvms.xd)),...
                        IncreasingBellShapedFunction(uvms.ensured_distance_y, uvms.ensured_distance_y + 0.5, 0, 1, abs(uvms.yd))]).* mission.activationFunctions{8};
% uvms.A.distGoal = IncreasingBellShapedFunction(uvms.ensured_distance_x, 2, 0, 1, uvms.dist_to_goal_proj).* mission.activationFunctions{8};
