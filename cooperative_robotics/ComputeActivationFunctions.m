...
uvms.A.lbJointLimits = diag([DecreasingBellShapedFunction(uvms.jlmin(1), uvms.jlmin(1) + 0.2, 0, 1, uvms.q(1)),...
                             DecreasingBellShapedFunction(uvms.jlmin(2), uvms.jlmin(2) + 0.2, 0, 1, uvms.q(2)),...
                             DecreasingBellShapedFunction(uvms.jlmin(3), uvms.jlmin(3) + 0.2, 0, 1, uvms.q(3)),...
                             DecreasingBellShapedFunction(uvms.jlmin(4), uvms.jlmin(4) + 0.2, 0, 1, uvms.q(4)),...
                             DecreasingBellShapedFunction(uvms.jlmin(5), uvms.jlmin(5) + 0.2, 0, 1, uvms.q(5)),...
                             DecreasingBellShapedFunction(uvms.jlmin(6), uvms.jlmin(6) + 0.2, 0, 1, uvms.q(6)),...
                             DecreasingBellShapedFunction(uvms.jlmin(7), uvms.jlmin(7) + 0.2, 0, 1, uvms.q(7))]) .* mission.activationFunctions{10};

%%  ACTIVATION FUNCTION FOR AVOIDING UPPER BOUND JOINT LIMITS
uvms.A.ubJointLimits = diag([IncreasingBellShapedFunction(uvms.jlmax(1) - 0.2, uvms.jlmax(1), 0, 1, uvms.q(1)),...
                             IncreasingBellShapedFunction(uvms.jlmax(2) - 0.2, uvms.jlmax(2), 0, 1, uvms.q(2)),...
                             IncreasingBellShapedFunction(uvms.jlmax(3) - 0.2, uvms.jlmax(3), 0, 1, uvms.q(3)),...
                             IncreasingBellShapedFunction(uvms.jlmax(4) - 0.2, uvms.jlmax(4), 0, 1, uvms.q(4)),...
                             IncreasingBellShapedFunction(uvms.jlmax(5) - 0.2, uvms.jlmax(5), 0, 1, uvms.q(5)),...
                             IncreasingBellShapedFunction(uvms.jlmax(6) - 0.2, uvms.jlmax(6), 0, 1, uvms.q(6)),...
                             IncreasingBellShapedFunction(uvms.jlmax(7) - 0.2, uvms.jlmax(7), 0, 1, uvms.q(7))]) .* mission.activationFunctions{11};
