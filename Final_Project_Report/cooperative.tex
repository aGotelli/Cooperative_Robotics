...
\begin{gather*}
uvms.Jv\_pos = \begin{bmatrix} zeros(3, 7) & uvms.wTv(1:3, 1:3) & zeros(3,3)\end{bmatrix} \\
uvms.Jv\_att = \begin{bmatrix} zeros(3, 7) & zeros(3, 3) & uvms.wTv(1:3, 1:3)\end{bmatrix}
\end{gather*}
